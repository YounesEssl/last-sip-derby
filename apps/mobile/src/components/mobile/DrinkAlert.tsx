    ...
    >
      <div className="w-full max-w-xs flex flex-col items-center text-center">
        ...
        <div className="relative mb-4">
          <div className="text-[80px] font-display leading-none text-red-500"
            style={{ textShadow: '0 0 40px rgba(239,68,68,0.5)' }}
          >
            {notification.sips}
          </div>
          <p className="text-lg font-mono text-red-300 uppercase tracking-widest -mt-1">
        ...
        >
          <h2 className="font-display text-3xl text-red-400 tracking-widest">BOIS !</h2>
        </div>

        {/* Reason */}
        <p className="font-mono text-sm text-white/50 leading-relaxed px-4 mb-6">
          {notification.reason}
        </p>
