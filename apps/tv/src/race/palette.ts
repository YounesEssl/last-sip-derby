...
export const SPONSORS = [
  ...
  'arrête de mentir',
  'tié un tigre',
  'C’est David c’est la rue',
  'Un peu de gazouz',
  'vive les gros nichons',
  'PSG double champions d’Europe',
  'Messi GOAT',
  'CR7 GOAT',
  'Buvez tous !',
  'pète ton flash',
  ...
  'La marmite',
  'Momo Kebab - sponsor de la 3ème mi-temps',
  ...
  "J'étais la Gandalf",
  'Huitre et palourde',
  'Ser Illyn, apportez-moi sa tête !',
  'LE BOULET HUMAIN !!',
  'WESH ENFOIRÉ',
  "BÉBÉ J'ARRRRRRRRRIVEEEEE",
